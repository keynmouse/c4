...
def main(args=None):
    ...
    node = rclpy.create_node("test_turn", namespace=ROBOT_ID)
    ...
    def turn_cup_2(posx2):
        ...
        set_digital_output(2,ON)
        wait(1)
        movel([0,0,350,0,0,0],vel=VELOCITY,acc=ACC,ref=DR_BASE,mod=DR_MV_MOD_REL)
        movel([406.72, -33.94, 350, 173.27, 180, 173.83],vel=VELOCITY,acc=ACC,ref=DR_BASE)
